...
![Install with new progress bar](http://shared.by.re-becca.org/misc-images/new-gauge-colour.gif)
...
* `colorASCII` – Inverts the colour of the completed portion of the progress
...
* [`6b0031e`](https://github.com/npm/npm/commit/6b0031e28c0b10fb2622fdadde41f5cd294348e8)
  ...
  Correct documentation regarding the defaults for the `colour` config option.
...
* [`8733bff`](https://github.com/npm/npm/commit/8733bff) `supports-colour@2.0.0`
