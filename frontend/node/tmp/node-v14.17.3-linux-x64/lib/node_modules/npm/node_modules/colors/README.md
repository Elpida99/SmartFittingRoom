...
[![devDependencies](https://david-dm.org/Marak/colors.js/dev-statusEnum.svg)](https://david-dm.org/Marak/colors.js#info=devDependencies)
...
## get colour and style in your node.js console
...
console.log('inverse the colour'.inverse); // inverses the colour
...
console.log(colors.inverse('inverse the colour')); // inverses the colour
