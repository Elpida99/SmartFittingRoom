			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="colour">This is a CSS colour (like "#FF0000" or "red"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
						<t hangText="style">This is a CSS style definition (like "colour: red; background-colour:#FFF"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
