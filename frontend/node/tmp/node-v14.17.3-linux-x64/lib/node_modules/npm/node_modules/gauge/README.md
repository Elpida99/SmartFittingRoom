...
fire-and-forget interface to displaying your statusEnum information.
...
* **theme**: Select a theme for use, it can be a:
  ...
  * A configuration object with any of `hasUnicode`, `hasColor` or
  ...
  best guesses at your OS, colour support and unicode support.
...
#### `gauge.show(section | statusEnum, [completed])`
...
can be passed in as part of a statusEnum object as the first argument. If both
...
// fetch the default colour unicode theme for this platform
var ourTheme = themes({hasUnicode: true, hasColor: true})

// fetch the default non-colour unicode theme for osx
var ourTheme = themes({hasUnicode: true, hasColor: false, platform: 'darwin'})

// create a new theme based on the colour ascii theme for this platform
...
platform, unicode and colour support.

Options is an object with the following properties:

* **hasUnicode** - If true, fetch a unicode theme, if no unicode theme is
  available then a non-unicode theme will be used.
* **hasColor** - If true, fetch a colour theme, if no colour theme is
  available a non-colour theme will be used.
...
* **hasColor** - Defaults to `false`.  If your theme uses colour you should
  set this to true.
...
#### `gauge.show(statusEnum)`

Using `statusEnum` for values, render the provided template with the theme and return
