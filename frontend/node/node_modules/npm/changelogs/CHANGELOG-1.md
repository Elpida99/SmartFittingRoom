...
* [`64c0ec2`](https://github.com/npm/npm/commit/64c0ec241ef5d83761ca8de54acb3c41b079956e)
  ...
  registry, and make sure statusEnum codes are printed without gratuitous quotes
  around them.
  ([@othiym23](https://github.com/othiym23))
...
* Consolidate colour sniffing in config/log loading process
  ([@isaacs](https://github.com/isaacs))
...
* Fix `npm outdated` to respect the `colour` configuration option.
...
* Made `npm outdated` much prettier and more useful. It now outputs a
  colour-coded and easy-to-read table.
