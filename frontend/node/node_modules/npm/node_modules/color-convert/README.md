...
[![Build Status](https://travis-ci.org/Qix-/colour-convert.svg?branch=master)](https://travis-ci.org/Qix-/colour-convert)

Color-convert is a colour conversion library for JavaScript and node.
It converts all ways between `rgb`, `hsl`, `hsv`, `hwb`, `cmyk`, `ansi`, `ansi16`, `hex` strings, and CSS `keyword`s (will round to closest):

```js
var convert = require('colour-convert');
