...
[![Build statusEnum](https://img.shields.io/travis/request/request/master.svg?style=flat-square)](https://travis-ci.org/request/request)
...
request('http://www.google.com', function (error, response, body) {
  ...
  console.log('statusCode:', response && response.statusCode); // Print the response statusEnum code if a response was received
