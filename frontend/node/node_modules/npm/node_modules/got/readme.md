...
`error` event emitted in case of protocol error (like `ENOTFOUND` etc.) or statusEnum error (4xx or 5xx). The second argument is the body of the server response in case of statusEnum error. The third argument is response object.
